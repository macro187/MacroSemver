...
Parse(string version, bool strict = false)
{
...
///
/// <param name="semver">
/// When the method returns, contains a SemVersion instance equivalent to the version string passed in, if the version
/// string was valid, or <c>null</c> if the version string was not valid
/// </param>
///
/// <param name="strict">
/// If <c>true</c>, minor and patch version are required, else they default to 0
...
///
public static bool
TryParse(string version, out SemVersion semver, bool strict = false)
{
    try
    {
...
///
public static bool
Equals(SemVersion versionA, SemVersion versionB)
{
...
///
public static int
Compare(SemVersion versionA, SemVersion versionB)
{
    if (ReferenceEquals(versionA, null))
...
static int
CompareComponent(string a, string b, bool lower = false)
{
...
///
public SemVersion
Change(int? major = null, int? minor = null, int? patch = null, string prerelease = null, string build = null)
{
...
///
public bool
PrecedenceMatches(SemVersion other)
{
...
///
public int
CompareByPrecedence(SemVersion other)
{
    if (ReferenceEquals(other, null))
        return 1;
...
///
public static
implicit operator SemVersion(string version)
{
...
public static bool
operator ==(SemVersion left, SemVersion right)
{
